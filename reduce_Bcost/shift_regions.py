import os
from .streamB_utils import (normalize_image, find_region_same_id, draw_region_rectangle)
...
def pack_filtered_padded_regions(
    ...
    for rect in all_rects:
        ...
        merged_new_regions_dict[rid].blank_x += shift_x
        merged_new_regions_dict[rid].blank_y += shift_y
